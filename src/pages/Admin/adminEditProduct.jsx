...
export default function AdminEditProductForm() {
    ...
    async function editproduct(){
        ...
        try{
            ...
            await api.put("products/"+productId,reqbody,{
                headers:{
            ...
            toast.error(err?.response?.data?.message || "An error occured while updating the product.");
        ...
        <div className="h-full w-full flex items-center flex-col">
            ...
            <div className="w-full h-[100px]  bg-white shadow-2xl rounded-lg flex p-4 item-center justify-between">
                ...
                <div className="h-full gap-4 flex items-center" >
                    ...
                    <button className="bg-green-600 text-white w-[100px] text-center py-2 rounded-lg cursor-pointer " onClick={editproduct} >{
            ...
            <div className="w-full p-4 flex flex-wrap">
                <div className="w-[25%] h-[70px] flex-col px-2 my-2">
                    ...
                    <input value={productId} disabled onChange={(e)=>{
